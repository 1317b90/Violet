...
import { useRDactivate } from '@/stores/RDactivate'
import { generRDactive } from '@/request/api'


const S = useRDactivate()
...
async function getGener() {
    ...
    try {
        const res = await generRDactive(fileList);
