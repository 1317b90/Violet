    ...
    <div class="content">
        ...
        <div v-if="generContent" class="contentDiv">
            <el-input v-model="generContent" :autosize="{ minRows: 3 }" type="textarea" show-word-limit
                :maxlength="1000" placeholder="Please input" @change="onSave" />
...
import { generManage } from '@/request/api'
...
async function getGener() {
    ...
    try {
        const res = await generManage(fileList);
